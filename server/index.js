...
set("debug", true);
app.use(json({ limit: "500mb", parameterLimit: 100000 }));
app.use(urlencoded({ limit: "500mb", extended: false }));
app.use(cors());
...
async function connecting() {
  try {
    await connect(
      `mongodb+srv://geewizz:${process.env.PASS}@mem-spaced.ov6ix3g.mongodb.net/mem-spaced?retryWrites=true&w=majority`
    );
